...
<Library LVVersion="19008000">
	...
	<Item Name="CSV to HTTP.vi" Type="VI" URL="../CSV to HTTP.vi"/>
	<Item Name="Parse HTTP Response Headers.vi" Type="VI" URL="../Parse HTTP Response Headers.vi"/>
	<Item Name="Parse Query String.vi" Type="VI" URL="../Parse Query String.vi"/>
	<Item Name="Remove First and Last.vi" Type="VI" URL="../../OneNote VIs/Remove First and Last.vi"/>
</Library>
